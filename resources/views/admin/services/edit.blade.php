...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title h5">{{ __('keywords.edit_service') }}</h2>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control"
                                            placeholder="{{ __('keywords.enter_title') }}" value="{{ $service->title }}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea type="text" name="description" class="form-control" placeholder="{{ __('keywords.description') }}">{{ $service->description }}</textarea>
