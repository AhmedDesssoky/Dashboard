...
class MemberController extends Controller
{
    ...
    public function store(StoreMemberRequest $request)
    {
       ...
       // image uploading
        ...
        Member::create($data);
        return to_route('admin.members.index')->with('success',__('keywords.record_created_success'));
    }
    ...
    public function update(UpdateMemberRequest $request, Member $member)
    {
      ...
      if ($request->hasFile('image')) {
       ...
       $member->update($data);
        return to_route('admin.members.index')->with('success',__('keywords.record_updated_success'));
    }
    ...
    {
        $member->delete();
        return to_route('admin.members.index')->with('success',__('keywords.record_deleted_success'));
    }
}
